...
import com.johny.bravo.tree.Binary_Search_Tree;
	...
	public static void main(String[] args) throws IOException {
		...
		while (true) {
			...
			switch(ch) {
				...
				case 7 :
					System.out.println("\n Height of Binary Tree : "+bst.heightOfTree());
					break;
					
				case 8 :
					System.out.println("\n Smallest node : "+bst.minNode());
					System.out.println("\n Biggest node : "+bst.maxNode());
					break;
				...
				case 15 :
					...
					Comparable[] in_order_list_binary = bst.InOrderTraversalBinary(tree_size);
					Comparable[] sorted_in_order_list_binary = Quick.sort(in_order_list_binary);
					bst.BSTFromBinaryTree(sorted_in_order_list_binary);
					break;
				...
				case 20 :
					...
					System.out.println("\n Enter 2nd Node : ");
					int i2 = in.nextInt();
					int dbn = bst.distanceBetwNodes(i1, i2);
					if(dbn == -1)
						System.out.println("\n Error : Either the Tree is empty or nodes are not present");
					else
				...
				case 27 :
					...
					if(bst.search(p))
						...
						System.out.println("\n The Requested node is not present in the Tree !!");
					break;
